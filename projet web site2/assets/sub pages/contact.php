...
if(isset($_SESSION['nom']) & isset($_SESSION['prenom'])){
    echo "<script type=\"text/javascript\"> window.location='./sub pages home/contact.php' </script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="navbar navbar-expand-lg bg-dark navbar-dark text-white "> <!-- use fixed-top for fix nav -->
        <div class="container">
            <!-- logo & name site -->
