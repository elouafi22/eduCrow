...
if (isset($_SESSION['nom']) & isset($_SESSION['prenom'])) {
  echo "<script type=\"text/javascript\"> window.location='./sub pages home/about us.php' </script>";
}
?>
            ...
            <div class="row text-center py-5">
                <div class="col-md">
                  <div class="card bg-dark text-light mb-3">
                        <img  src="./../image/SAVE_20211108_191859(2).jpg" alt="card-image" class="card-img-top">
