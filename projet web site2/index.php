...
if (isset($_SESSION['nom'])) {
    echo "<script type=\"text/javascript\"> window.location='./assets/sub pages/home.php' </script>";
}
...
<body>
    ...
    <div class="navbar navbar-expand-lg bg-dark navbar-dark text-white ">
        ...
        <div class="container">
            ...
            <a href="./index.php" class="navbar-brand">
                <img class="w-50" src="./assets/image/img svg/mortarboard.svg">
            ...
            <div class="collapse navbar-collapse" id="main-menu">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item nav-l"><a href="./assets/sub pages/contact.php" class="nav-link">Contact</a></li>
                    <li class="nav-item"><a href="./assets/sub pages/about us.php" class="nav-link">About US</a></li>
                    <li class="nav-item"><a href="./assets/sub pages/log in.php" class="nav-link"><span class="text-primary">Log in</span></a></li>
                    <li class="nav-item"><a href="./assets/sub pages/sign in.php" class="nav-link"><span class="text-primary">Sign Up</span></a></li>
                </ul>
            </div>
        ...
        <div class="container">
            <div class="d-flex align-items-center">
                <div>
                    ...
                    <a href="./assets/sub pages/log in.php"><button class="btn btn-info">Log in</button></a>
                    <a href="./assets/sub pages/sign in.php"><button class="btn btn-danger ms-4">Sign up</button></a>
                </div>
                <img id="imagesvg" class="d-none d-md-block img-fluid w-100" src="./assets/image/img svg/undraw_certification_aif8.svg" alt="hero">
            </div>
        </div>
    </section>
            ...
            <div class="row text-center py-5">
                <div class="col-md">
                    <div class="card bg-dark text-light mb-3">
                        <img src="./assets/image/card-img1.webp" alt="card-image" class="card-img-top">
                ...
                <div class="col-md">
                    <div class="card bg-dark text-light mb-3">
                        <img src="./assets/image/card-img2.webp" alt="card-image" class="card-img-top">
                        <div class="card-body text-center">
                            <h4 class="card-title">Learning About your filière</h4>
                ...
                <div class="col-md">
                    <div class="card bg-dark text-light mb-3">
                        <img src="./assets/image/card-img3.webp" alt="card-image" class="card-img-top">
                        <div class="card-body text-center">
                            <h4 class="card-title">Safety regulations </h4>
    ...
    <section class="py-5">
        <div class="container">
            <div class="row align-items-center justify-content-md-center">
                <div class="col-md">
                    <img src="./assets/image/img svg/undraw_online_learning_re_qw08.svg" alt="learn" class="img-fluid">
                </div>
    ...
    <section id="filiere" class="py-5 bg-black text-light">
        <div class="container">
            <div class="row align-items-center justify-content-md-center flex-row-reverse">
                <div class="col-md">
                    <img src="./assets/image/img svg/undraw_bookshelves_re_lxoy.svg" alt="learn" class="img-fluid">
                </div>
                <div class="col-md py-4">
    ...
    <section id="safty" class="py-4">
        <div class="container lead">
            <div class="row align-items-center justify-content-md-center ">
                <div class="col-md">
                    <img src="./assets/image/img svg/undraw_medicine_b-1-ol.svg" alt="medicine image" class="img-fluid">
                </div>
                <div class="col-md py-4">
